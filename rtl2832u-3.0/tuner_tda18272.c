	...
	)
{
	...
	for(i = 0; i < ReadLen; i += ReadingByteNumMax)
	{
		...
		if(pI2cBridge->ForwardI2cWritingCmd(pI2cBridge, DeviceAddr, &RegReadingAddr, (u64)AddrSize) != FUNCTION_SUCCESS)
	...
	)
{
	...
	WritingByteNum = (u8)(AddrSize + WriteLen);
