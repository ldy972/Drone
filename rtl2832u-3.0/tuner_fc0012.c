	...
	)
{
	...
	if(FC0011_SetFrequency(pTuner, RfFreqKhz, (u16)(pExtra->BandwidthMode)) != FC0012_FUNCTION_SUCCESS)
	...
	)
{
	...
	if(FC0011_SetFrequency(pTuner, RfFreqKhz, (u16)BandwidthMode) != FC0012_FUNCTION_SUCCESS)
...
s32 FC0012_Read(TUNER_MODULE *pTuner, u8 RegAddr, u8 *pByte)
{
...
s32 FC0012_Write(TUNER_MODULE *pTuner, u8 RegAddr, u8 Byte)
{
	I2C_BRIDGE_MODULE *pI2cBridge;
	u8 DeviceAddr;
...
//void FC0012_Write(u8 address, u8 data);
//u8 FC0012_Read(u8 address);
//void FC0012_Open();
//void FC0012_Close();
//void FC0012_SetFrequency(u32 Frequency, u16 Bandwidth);
...
s32 FC0012_Open(TUNER_MODULE *pTuner)
{
	FC0012_EXTRA_MODULE *pExtra;
...
void FC0012_Frequency_Control(u32 Frequency, u16 Bandwidth)
{
...
// Frequency unit: KHz, bandwidth unit: MHz
s32 FC0011_SetFrequency(TUNER_MODULE *pTuner, u64 Frequency, u16 Bandwidth)
{
//    bool VCO1 = false;
//    u32 doubleVCO;
//    u16 xin, xdiv;
//	u8 reg[21], am, pm, multi;
    s32 VCO1 = FC0012_FALSE;
    u64 doubleVCO;
    u16 xin, xdiv;
	u8 reg[21], am, pm, multi;
	u8 read_byte;
...
//	xdiv = (u16)(doubleVCO / 14400);		// implement round function, 2009-05-01 by Arios
//	if( (doubleVCO - xdiv * 14400) >= 7200 )
	xdiv = (u16)(doubleVCO / (CrystalFreqKhz / 2));		// implement round function, 2009-05-01 by Arios
...
//	xin = (u16)(doubleVCO - ((u16)(doubleVCO / 14400)) * 14400);						
//	xin = ((xin << 15)/14400);															
	xin = (u16)(doubleVCO - ((u16)(doubleVCO / (CrystalFreqKhz / 2))) * (CrystalFreqKhz / 2));						
	xin = ((xin << 15)/(u16)(CrystalFreqKhz / 2));															
