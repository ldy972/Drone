...
typedef s32 (*DTMB_DEMOD_FP_ADDR_8BIT_GET_REG_BITS_WITH_PAGE)(DTMB_DEMOD_MODULE* pDemod,
                                                              s32 RegBitName,
                                                              u64* pReadingValue);
...
*/
typedef s32 (*DTMB_DEMOD_FP_SET_SPECTRUM_MODE)(DTMB_DEMOD_MODULE *pDemod,
                                               s32 SpectrumMode);
...
*/
typedef s32 (*DTMB_DEMOD_FP_GET_BER)(DTMB_DEMOD_MODULE* pDemod, u64* pBerNum, u64* pBerDen);
...
*/
typedef s32 (*DTMB_DEMOD_FP_GET_SNR_DB)(DTMB_DEMOD_MODULE *pDemod, s64* pSnrDbNum, s64* pSnrDbDen);
...
*/
typedef s32 (*DTMB_DEMOD_FP_GET_IF_AGC)(DTMB_DEMOD_MODULE *pDemod, s64* pIfAgc);
...
struct DTMB_DEMOD_MODULE_TAG
{
	...
	u64 CrystalFreqHz;
	s32           TsInterfaceMode;
	s32           DiversityPipMode;

	u64 IfFreqHz;
	s32           SpectrumMode;

	s32 IsIfFreqHzSet;
	s32 IsSpectrumModeSet;
