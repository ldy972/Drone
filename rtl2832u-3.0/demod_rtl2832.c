...
*/
#ifndef DEMOD_RTL2832_H
#define DEMOD_RTL2832_H
...
void BuildRtl2832Module(DVBT_DEMOD_MODULE **ppDemod,
...
*/
void rtl2832_IsConnectedToI2c(DVBT_DEMOD_MODULE *pDemod, s32* pAnswer)
{
 ...
 */
s32 rtl2832_SoftwareReset(DVBT_DEMOD_MODULE *pDemod)
{
 ...
 */
s32 rtl2832_Initialize(DVBT_DEMOD_MODULE *pDemod)
{
	...
	{
		s32 RegBitName;
		u64 WritingValue[TS_INTERFACE_MODE_NUM];
	}
	...
	{
		s32 RegBitName;
		u64 WritingValue[RTL2832_APPLICATION_MODE_NUM];
	}
	...
	{
		if(pDemod->SetRegBitsWithPage(pDemod,
		                              InitTable[i].RegBitName,
                                    InitTable[i].WritingValue)
			!= FUNCTION_SUCCESS)
		{
			goto error_status_set_registers;
		}
	...
	{
		if(pDemod->SetRegBitsWithPage(pDemod,
		                              TsInterfaceInitTable[i].RegBitName,
		                              TsInterfaceInitTable[i].WritingValue[TsInterfaceMode])
			!= FUNCTION_SUCCESS)
		{
			goto error_status_set_registers;
		}
	...
	{
		if(pDemod->SetRegBitsWithPage(pDemod,
		                              AppInitTable[i].RegBitName,
		                              AppInitTable[i].WritingValue[AppMode])
			!= FUNCTION_SUCCESS)
		{
			goto error_status_set_registers;
		}
 ...
 */
s32 rtl2832_SetBandwidthMode(DVBT_DEMOD_MODULE *pDemod, s32 BandwidthMode)
{
	static const u8 HlpfxTable[DVBT_BANDWIDTH_MODE_NUM][RTL2832_H_LPF_X_LEN] =
	{
	...
	s64 CfreqOffRatioInt;
	u64 CfreqOffRatioBinary;
	...
	MpiGetValue(MpiVar0, (s64 *)&RsampRatio);
 ...
 */
s32 rtl2832_SetIfFreqHz(DVBT_DEMOD_MODULE *pDemod, u64 IfFreqHz)
{
	u64 CrystalFreqHz;
	u64 EnBbin;
 ...
 */
s32 rtl2832_SetSpectrumMode(DVBT_DEMOD_MODULE *pDemod, s32 SpectrumMode)
{
	u64 SpecInv;
 ...
 */
s32 rtl2832_IsTpsLocked(DVBT_DEMOD_MODULE *pDemod, s32 *pAnswer)
{
	u64 FsmStage;
...
/**
  ...
  */
s32 rtl2832_IsSignalLocked(DVBT_DEMOD_MODULE *pDemod, s32 *pAnswer)
{
	u64 FsmStage;
 ...
 */
s32 rtl2832_GetSignalStrength(DVBT_DEMOD_MODULE *pDemod, u64* pSignalStrength)
{
	u64 FsmStage;
	s64 IfAgc;
 ...
 */
s32 rtl2832_GetSignalQuality(DVBT_DEMOD_MODULE *pDemod, u64 *pSignalQuality)
{
	u64 FsmStage, RsdBerEst;
 ...
 */
s32 rtl2832_GetBer(DVBT_DEMOD_MODULE *pDemod, u64 *pBerNum, u64 *pBerDen)
{
	u64 RsdBerEst;
 ...
 */
s32 rtl2832_GetSnrDb(DVBT_DEMOD_MODULE *pDemod, s64 *pSnrDbNum, s64* pSnrDbDen)
{
	u64 FsmStage;
	u64 CeEstEvm;
	s32 Constellation, Hierarchy;

	static const s64 SnrDbNumConst[DVBT_CONSTELLATION_NUM][DVBT_HIERARCHY_NUM] =
	{
 ...
 */
s32 rtl2832_GetRfAgc(DVBT_DEMOD_MODULE *pDemod, s64 *pRfAgc)
{
	u64 Value;
	...
	*pRfAgc = (s32)BinToSignedInt(Value, RTL2832_RF_AGC_REG_BIT_NUM);
 ...
 */
s32 rtl2832_GetIfAgc(DVBT_DEMOD_MODULE *pDemod, s64 *pIfAgc)
{
	u64 Value;
	...
	*pIfAgc = (s32)BinToSignedInt(Value, RTL2832_IF_AGC_REG_BIT_NUM);
 ...
 */
s32 rtl2832_GetDiAgc(DVBT_DEMOD_MODULE *pDemod, u8 *pDiAgc)
{
	u64 Value;
 ...
 */
s32 rtl2832_GetTrOffsetPpm(DVBT_DEMOD_MODULE *pDemod, s64 *pTrOffsetPpm)
{
	u64 SfreqOffBinary;
	s64 SfreqOffInt;
 ...
 */
s32 rtl2832_GetCrOffsetHz(DVBT_DEMOD_MODULE *pDemod, s64 *pCrOffsetHz)
{
	s32 BandwidthMode;
	s32 FftMode;
	...
	s64 ConstWithBandwidthMode, ConstWithFftMode;
 ...
 */
s32 rtl2832_GetConstellation(DVBT_DEMOD_MODULE *pDemod, s32 *pConstellation)
{
	u64 ReadingValue;
 ...
 */
s32 rtl2832_GetHierarchy(DVBT_DEMOD_MODULE *pDemod, s32 *pHierarchy)
{
	u64 ReadingValue;
 ...
 */
s32 rtl2832_GetCodeRateLp(DVBT_DEMOD_MODULE *pDemod, s32 *pCodeRateLp)
{
	u64 ReadingValue;
 ...
 */
s32 rtl2832_GetCodeRateHp(DVBT_DEMOD_MODULE *pDemod, s32 *pCodeRateHp)
{
	u64 ReadingValue;
 ...
 */
s32 rtl2832_GetGuardInterval(DVBT_DEMOD_MODULE *pDemod, s32 *pGuardInterval)
{
	u64 ReadingValue;
 ...
 */
s32 rtl2832_GetFftMode(DVBT_DEMOD_MODULE *pDemod, s32 *pFftMode)
{
	u64 ReadingValue;
 ...
 */
s32 rtl2832_UpdateFunction(DVBT_DEMOD_MODULE *pDemod)
{
	RTL2832_EXTRA_MODULE *pExtra;
 ...
 */
s32 rtl2832_ResetFunction(DVBT_DEMOD_MODULE *pDemod)
{
	RTL2832_EXTRA_MODULE *pExtra;
 ...
 */
s32 rtl2832_ForwardI2cReadingCmd(I2C_BRIDGE_MODULE *pI2cBridge,
                                 u8 DeviceAddr,
                                 u8 *pReadingBytes,
                                 u64 ByteNum)
{
 ...
 */
s32 rtl2832_ForwardI2cWritingCmd(I2C_BRIDGE_MODULE *pI2cBridge,
                                 u8 DeviceAddr,
 ...
 */
void rtl2832_InitRegTable(DVBT_DEMOD_MODULE *pDemod)
{
 ...
 */
void rtl2832_BuildI2cBridgeModule(DVBT_DEMOD_MODULE *pDemod)
{
 ...
 */
void rtl2832_GetAppMode(DVBT_DEMOD_MODULE *pDemod, s32 *pAppMode)
{
	RTL2832_EXTRA_MODULE *pExtra;
 ...
 */
s32 rtl2832_func1_Reset(DVBT_DEMOD_MODULE *pDemod)
{
	RTL2832_EXTRA_MODULE *pExtra;
 ...
 */
s32 rtl2832_func1_Update(DVBT_DEMOD_MODULE *pDemod)
{
	RTL2832_EXTRA_MODULE *pExtra;

	s32 Answer;
	s32 MinWeightedBerConfigMode;
 ...
 */
s32 rtl2832_func1_IsCriterionMatched(DVBT_DEMOD_MODULE *pDemod, s32 *pAnswer)
{
	RTL2832_EXTRA_MODULE *pExtra;
 ...
 */
s32 rtl2832_func1_AccumulateRsdBerEst(DVBT_DEMOD_MODULE *pDemod,
                                      u64 *pAccumulativeValue)
{
	RTL2832_EXTRA_MODULE *pExtra;
 ...
 */
s32 rtl2832_func1_ResetReg(DVBT_DEMOD_MODULE *pDemod)
{
 ...
 */
s32 rtl2832_func1_SetCommonReg(DVBT_DEMOD_MODULE *pDemod)
{
 ...
 */
s32 rtl2832_func1_SetRegWithFftMode(DVBT_DEMOD_MODULE *pDemod,
                                    s32 FftMode)
{
	typedef struct
	{
		u64 Reg0[DVBT_FFT_MODE_NUM];
		u64 Reg1[DVBT_FFT_MODE_NUM];
	}
	FFT_REF_ENTRY;
 ...
 */
s32 rtl2832_func1_SetRegWithConfigMode(DVBT_DEMOD_MODULE *pDemod,
                                       s32 ConfigMode)
{
	typedef struct
	{
		u64 Reg0[RTL2832_FUNC1_CONFIG_MODE_NUM];
		u64 Reg1[RTL2832_FUNC1_CONFIG_MODE_NUM];
		u64 Reg2[RTL2832_FUNC1_CONFIG_MODE_NUM];
		u64 Reg3[RTL2832_FUNC1_CONFIG_MODE_NUM];
		u64 Reg4[RTL2832_FUNC1_CONFIG_MODE_NUM];

		u64 Reg5Ref[RTL2832_FUNC1_CONFIG_MODE_NUM];
		u64 Reg6Ref[RTL2832_FUNC1_CONFIG_MODE_NUM];
		u64 Reg7Ref[RTL2832_FUNC1_CONFIG_MODE_NUM];
	}
	CONFIG_REF_ENTRY;
	...
	static const u64 Const[DVBT_BANDWIDTH_MODE_NUM] =
	{
		// 6Mhz, 7Mhz, 8Mhz
		48,      56,   64,
	};
 ...
 */
void rtl2832_func1_GetMinWeightedBerConfigMode(DVBT_DEMOD_MODULE *pDemod,
                                               s32 *pConfigMode)
{
	RTL2832_EXTRA_MODULE *pExtra;

	u64 WeightedBerNormal;
	u64 WeightedBerConfig1;
	u64 WeightedBerConfig2;
	u64 WeightedBerConfig3;
