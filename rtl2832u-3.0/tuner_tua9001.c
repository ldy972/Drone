	...
	)
{
	...
	RfFreqKhz = (s64)((RfFreqHz + 500) / 1000);
	...
	pTuner->RfFreqHz      = (u64)(RfFreqKhz * 1000);
	...
	)
{
	...
	RfFreqKhz = (s64)(pTuner->RfFreqHz / 1000);
				 ...
				 u32 length)
{
	...
	u8 ByteNum;
	u8 WritingBytes[I2C_BUFFER_LEN];
	u32 i;
...
s32 initializeTua9001 (TUNER_MODULE *pTuner)
{
//  u32 counter;
  s8 i2cseq[2];
...
s32 tuneTua9001 (TUNER_MODULE *pTuner, s64 i_freq, tua9001tunerDriverBW_t i_bandwidth)
{
  s8 i2cseq[2];
  u32 divider_factor;
  u32 ch_offset;
//  u32 counter;
  u32 lo_path_settings;
//  tua9001tunerReceiverState_t tunerState;
  u8 DeviceAddr;
  ...
  if (i_freq < 1000000)    /*  divider factor and channel offset for UHF/VHF III */
   ...
   divider_factor   =  (u32) (((i_freq - 150000) * 48) / 1000);
   ...
   divider_factor   =  (u32) (((i_freq - 450000) * 48) / 1000);
...
s32 getPllLockedStateTua9001 (TUNER_MODULE *pTuner, tua9001tunerPllLocked_t *o_pll)
{
  s8 i2cseq[2];
  u8 DeviceAddr;
...
*/
/*
s32 getReceiverStateTua9001 (TUNER_MODULE *pTuner, tua9001tunerReceiverState_t *o_tunerState)
{
  s8 i2cseq[2];
  u8 DeviceAddr;
...
*/
/* 
s32 getActiveInputTua9001 (TUNER_MODULE *pTuner, tua9001tunerActiveInput_t *o_activeInput)
{
  s8 i2cseq[2];
  u8 DeviceAddr;
...
s32 getBasebandGainTua9001 (TUNER_MODULE *pTuner, s8 *o_basebandGain)
{
  s8 i2cseq[2];
  u8 DeviceAddr;
