...
#undef NXPFE
 ...
 #define Null            nullptr
    ...
    typedef s8   CInt8;   //  8 bit   signed integer
    typedef s16  CInt16;  // 16 bit   signed integer
    typedef s64   CInt32;  // 32 bit   signed integer
    typedef u8   CUInt8;  //  8 bit unsigned integer
    typedef u16  CUInt16; // 16 bit unsigned integer
    typedef u64   CUInt32; // 32 bit unsigned integer
//    typedef float           CFloat;  // 32 bit floating point
    typedef u32    CBool;   // Boolean (True/False)
    typedef s8            CChar;   // character, character array ptr
    typedef s32             CInt;    // machine-natural integer
    typedef u32    CUInt;   // machine-natural unsigned integer
...
//    typedef CFloat          Float;  // 32 bit floating point
    ...
    typedef s8           *String; // Null terminated 8 bit s8 str
    ...
    //
    typedef s8          *Address;        // Ready for address-arithmetic
    typedef s8 const    *ConstAddress;
    typedef u8  Byte;           // Raw byte
...
//    typedef double  Double, *pDouble; // 32/64 bit floating point
    ...
    typedef String *pString;          // Null terminated 8 bit s8 str,
#else
...
#define TMFL_NATIVE_INT64 1
    typedef signed   s64 s64 s32 Int64,  *pInt64;  // 64-bit integer
    typedef u64 s64 s32 UInt64, *pUInt64; // 64-bit bitmask
...
typedef struct _tmbslFrontEndDebugFunc_t
{
    ...
    tmErrorCode_t   (*Print)(UInt32 level, const s8* format, ...);
