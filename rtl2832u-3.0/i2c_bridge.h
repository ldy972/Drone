...
*/
typedef s32 (*I2C_BRIDGE_FP_FORWARD_I2C_READING_CMD)(I2C_BRIDGE_MODULE* pI2cBridge, u8 DeviceAddr, u8* pReadingBytes, u64 ByteNum);
...
*/
typedef s32 (*I2C_BRIDGE_FP_FORWARD_I2C_WRITING_CMD)(I2C_BRIDGE_MODULE *pI2cBridge, u8 DeviceAddr, const u8 *pWritingBytes, u64 ByteNum);
