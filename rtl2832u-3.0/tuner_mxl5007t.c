 ...
 */
void mxl5007t_GetTunerType(TUNER_MODULE *pTuner, s32 *pTunerType)
{
 ...
 */
void mxl5007t_GetDeviceAddr(TUNER_MODULE *pTuner, u8 *pDeviceAddr)
{
 ...
 */
s32 mxl5007t_Initialize(TUNER_MODULE *pTuner)
{
	MXL5007T_EXTRA_MODULE *pExtra;
	MxL5007_TunerConfigS *pTunerConfigS;
 ...
 */
s32 mxl5007t_SetRfFreqHz(TUNER_MODULE *pTuner, u64 RfFreqHz)
{
	MXL5007T_EXTRA_MODULE *pExtra;
	MxL5007_TunerConfigS *pTunerConfigS;
 ...
 */
s32 mxl5007t_GetRfFreqHz(TUNER_MODULE *pTuner, u64 *pRfFreqHz)
{
 ...
 */
s32 mxl5007t_SetBandwidthMode(TUNER_MODULE *pTuner, s32 BandwidthMode)
{
	MXL5007T_EXTRA_MODULE *pExtra;
	MxL5007_TunerConfigS *pTunerConfigS;
 ...
 */
s32 mxl5007t_GetBandwidthMode(TUNER_MODULE *pTuner, s32 *pBandwidthMode)
{
	MXL5007T_EXTRA_MODULE *pExtra;
