...
*/
s32 rtl2836_SetIfFreqHz(DTMB_DEMOD_MODULE *pDemod, u64 IfFreqHz)
{
	u64 BbinEn, EnDcr;
	u64 IfFreqHzAdj;
...
*/
s32 rtl2836_GetSnrDb(DTMB_DEMOD_MODULE *pDemod, s64 *pSnrDbNum, s64 *pSnrDbDen)
{
	u64 EstSnr;
...
*/
s32 rtl2836_GetRfAgc(DTMB_DEMOD_MODULE *pDemod, s64 *pRfAgc)
{
	u64 RfAgcVal;
	...
	*pRfAgc = (s64)BinToSignedInt(RfAgcVal, RTL2836_RF_AGC_REG_BIT_NUM);
 ...
 */
s32 rtl2836_GetIfAgc(DTMB_DEMOD_MODULE *pDemod, s64* pIfAgc)
{
	u64 IfAgcVal;
	...
	*pIfAgc = (s64)BinToSignedInt(IfAgcVal, RTL2836_IF_AGC_REG_BIT_NUM);
...
*/
s32 rtl2836_GetDiAgc(DTMB_DEMOD_MODULE *pDemod, u64 *pDiAgc)
{
	u64 GainOutR;
