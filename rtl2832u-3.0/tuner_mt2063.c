 ...
 */
void mt2063_GetTunerType(TUNER_MODULE *pTuner, s32 *pTunerType)
{
 ...
 */
void mt2063_GetDeviceAddr(TUNER_MODULE *pTuner, u8* pDeviceAddr)
{
 ...
 */
s32 mt2063_Initialize(TUNER_MODULE *pTuner)
{
	MT2063_EXTRA_MODULE *pExtra;
 ...
 */
s32 mt2063_SetRfFreqHz(TUNER_MODULE *pTuner,	u64 RfFreqHz)
{
	MT2063_EXTRA_MODULE *pExtra;
