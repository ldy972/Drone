...
*/
typedef s32 (*DVBT_DEMOD_FP_GET_REG_BITS_WITH_PAGE)(DVBT_DEMOD_MODULE* pDemod,
                                                    s32 RegBitName,
                                                    u64* pReadingValue);
...
struct RTL2830_EXTRA_MODULE_TAG
{
	...
	s32 IsFunction2Enabled;
	s32 IsFunction3Enabled;
	s32 IsFunction4Enabled;
	s32 IsFunction5Enabled;
	...
	u8 Func4State;
	u64 Func4DelayCnt;
	u64 Func4DelayCntMax;
	u8 Func4ParamSetting;
	u64 Func4RegValue[DVBT_FUNC4_REG_VALUE_NUM];
	u8 Func5State;
	u8 Func5QamBak;
	u8 Func5HierBak;
	u8 Func5LpCrBak;
...
struct RTL2832_EXTRA_MODULE_TAG
{
	...
	s32 Func1WaitTimeMax;
	s32 Func1GettingTimeMax;
	s32 Func1GettingNumEachTime;

	s32 Func1WaitTime;
	s32 Func1GettingTime;

	u64 Func1RsdBerEstSumNormal;
	u64 Func1RsdBerEstSumConfig1;
	u64 Func1RsdBerEstSumConfig2;
	u64 Func1RsdBerEstSumConfig3;
