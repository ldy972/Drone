	...
	)
{
	...
	CalculatedValue = (u16)((RfFreqHz + (FreqUnit / 2)) / FreqUnit);
	...
	)
{
	...
	// Note: Call MAX3543 source code function.
	BandwidthModeUshort = (u16)BandwidthMode;
	...
	)
{
	...
	WritingBuffer[0] = (u8)RegAddr;
	WritingBuffer[1] = (u8)Data;
...
//	IF_Frequency = scalefrq(36.125); 
	...
	// Note: 1. CalculatedValue = round(RfFreqHz / FreqUnit)
	//       2. Call MAX3543 source code function.
	CalculatedValue = (u16)((pExtra->IfFreqHz + (FreqUnit / 2)) / FreqUnit);
