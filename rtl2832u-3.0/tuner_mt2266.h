...
**  Data Types
*/
typedef u8   U8Data;         /*  type corresponds to 8 bits      */
typedef u32    UData_t;        /*  type must be at least 32 bits   */
typedef s32             SData_t;        /*  type must be at least 32 bits   */
...
// Builder
void BuildMt2266Module(TUNER_MODULE **ppTuner,
...
void mt2266_GetTunerType(TUNER_MODULE *pTuner, s32 *pTunerType);

void mt2266_GetDeviceAddr(TUNER_MODULE *pTuner, u8 *pDeviceAddr);

s32 mt2266_Initialize(TUNER_MODULE *pTuner);

s32 mt2266_SetRfFreqHz(TUNER_MODULE *pTuner, u64 RfFreqHz);

s32 mt2266_GetRfFreqHz(TUNER_MODULE *pTuner, u64 *pRfFreqHz);


// Extra manipulaing functions
s32 mt2266_OpenHandle(TUNER_MODULE *pTuner);

s32 mt2266_CloseHandle(TUNER_MODULE *pTuner);

void mt2266_GetHandle(TUNER_MODULE *pTuner, void **pDeviceHandle);

s32 mt2266_SetBandwidthHz(TUNER_MODULE *pTuner, u64 BandwidthHz);

s32 mt2266_GetBandwidthHz(TUNER_MODULE *pTuner, u64 *pBandwidthHz);
